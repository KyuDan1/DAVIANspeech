...
from wpt_spectra_inference import apply_wpt_standalone_fusion  # noqa: E402
...
def main():
    ...
    apply_wpt_standalone_fusion(
        ...
        voice_weight=0.05, file_weight=0,
    )
    for path in (eat_stats, spear_stats, eat_patch_graph, spear_component_bins):
