...
from three_stream_anchor_residual_inference import apply_three_stream_anchor_residual  # noqa: E402
...
def main():
    ...
    args.xlsr_window_embeddings_output = None
    run(args)
    ...
    sys.path.insert(0, str(BASE_DIR / "model" / "music82"))
