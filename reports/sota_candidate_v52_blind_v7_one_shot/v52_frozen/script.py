...
from eat_patch_graph_inference import apply_eat_patch_graph_fusion  # noqa: E402
from component_query_mhfa_inference import apply_component_query_mhfa_fusion  # noqa: E402
from music_only_residual import apply_component_query_music_residual  # noqa: E402
...
from component_consistent_file_fusion import apply_component_consistent_file_fusion  # noqa: E402
...
def main():
    ...
    eat_patch_graph = BASE_DIR / "output" / ".eat_patch_graph.npz"
    spear_component_bins = BASE_DIR / "output" / ".spear_component_bins.npz"
    spectra_stats = BASE_DIR / "output" / ".spectra_voice_v49.npz"
    ...
    apply_component_query_mhfa_fusion(
    ...
    # Frozen v51: original-mixture Music only; no extra backbone pass.
    ...
    # Frozen seed06 original-audio WPT: File only.
    ...
    # Frozen v24 experts: Voice only. All File update weights stay zero.
    ...
    # Run last: consume every upstream specialist's final component scores.
    apply_component_consistent_file_fusion(
        args.output, file_weight=0.2,
        voice_presence_threshold=0.1,
        music_presence_threshold=0.2,
    )
    for path in (
