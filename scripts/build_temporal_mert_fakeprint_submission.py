#!/usr/bin/env python3
"""Build v16 temporal MIL plus low-weight MERT and modern fakeprint experts."""
...
"""DACON entrypoint: LME+SPEAR, temporal MIL, MERT/fakeprint, CPS."""
...
def main() -> None:
    ...
    parser.add_argument("--base", type=Path, default=ROOT / "temporal_mil_cps_v16")
    ...
    for name in ("modern_fakeprint_detector.py", "sofia_mert_detector.py"):
    ...
    fakeprint = args.output / "model" / "modern-fakeprint"
    fakeprint.mkdir(parents=True)
    shutil.copy2(ROOT / "models" / "modern-fakeprint-v1" / "weights.npz",
                 fakeprint / "weights.npz")
    shutil.copy2(ROOT / "models" / "modern-fakeprint-v1" / "LICENSE",
                 fakeprint / "LICENSE")
